...
class TitleScene(Scene):
 def construct(self):
        ...
        # Title
        title = Text("Latent Space's and VAE's", color=WHITE, font='Comic Sans MS').scale(1).set_stroke(BLACK, width=1).move_to(UP * 1)
        ...
        for _ in range(5):  # Repeat a few times for dynamic effect
            ...
            self.play(
                ...
                run_time=1.5,  # Slower animation for smoother transitions
